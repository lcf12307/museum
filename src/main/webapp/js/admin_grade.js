...
function showGrade(t) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $('#chooseDiv').hide();
            $('#listDiv').empty();
            $('#listDiv').append('<table class="table table-bordered"><tr><th>学号</th><th>姓名</th><th>班级</th><th>专业</th><th>成绩</th></tr>')
...
function showList() {
    ...
    $.ajax({
        ...
        success: function (data) {
            $('#listDiv').empty();
            $('#listDiv').append('<table class="table table-bordered" > <tr> <th>课程ID</th> <th>开设ID</th> <th>课程名称</th> <th>学分</th> <th>性质</th> <th>开设院系</th> <th>学年</th> <th>学期</th> <th>人数上限</th> <th>查看</th> </tr>')
