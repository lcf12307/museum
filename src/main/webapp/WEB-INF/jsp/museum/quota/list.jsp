    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div>
                ...
                <a class = "btn btn-primary" href="/museum/quota/appoint/1" target="_self">取消年份</a>
                <a class = "btn btn-primary" href="/museum/quota/appoint2/1" target="_self">指定年份</a>
            </div>
            <br>
            ...
            <div class="panel-body" >
                        ...
                        <c:when test="${list.size() != 0}">
                            ...
                            <c:forEach items="${list}" var="quota">
                                ...
                                %>
                                    ...
                                    <td>${quota.name}</td>
                                    <td>${quota.quotaId}</td>
                                    <td><a class="btn btn-info" href="/museum/quota/detail/${quota.id}" target="_self">查看</a>
                                        <a class="btn btn-info" href="/museum/quota/edit/${quota.id}" target="_self">编辑</a>
                                        <a class="btn btn-danger" onclick="delQuota('${quota.name}')" target="_blank">删除</a>
                                    </td>
                                </tr>
                ...
                <div align="right">
                    <a class="btn btn-primary" href="/museum/quota/list/1" target="_self">第一页</a>
