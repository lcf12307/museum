...
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/AdminLTE.min.css?v=1.1">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/libs/bootstrapValidator/css/bootstrapValidator.min.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/plugins/jqgrid/ui.jqgrid-bootstrap.css">
...
<script src="${pageContext.request.contextPath}/statics/libs/bootstrapValidator/js/bootstrapValidator.min.js"></script>
<script src="${pageContext.request.contextPath}/statics/libs/bootstrapValidator/js/language/zh_CN.js"></script>
