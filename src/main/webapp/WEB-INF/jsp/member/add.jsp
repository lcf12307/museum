        ...
        <section class="content" style="background:#fff;">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" >
                    <form class="form-horizontal" id="add_member_from" method="post" target="hiddenFrame">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="age" name="age" type="number" min="1" max="99" required/>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function () {
        $('#add_member_from').bootstrapValidator({
            fields: {
                name:{
                    validators:{
                        stringLength: {
        ...
        $('#add_member_from').on('click','#sub',function(e){
            //post提交
            e.preventDefault();//阻止提交
            $("#add_member_from").data('bootstrapValidator').validate();
            var flag = $("#add_member_from").data('bootstrapValidator').isValid();
            if(!flag)
                return;
            $.ajax({
                type: "POST",
