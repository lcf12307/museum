...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div>
                <button class="btn btn-primary" onclick="window.location.href='/admin/teacher/insertPage'">添加教师</button>
                <button class="btn btn-primary" onclick="window.location.href='/admin/teacher/download'">下载报表</button>
                 <button class="btn btn-primary" onclick="window.location.href='/admin/teacher/upload'">上传报表</button>
            </div>
            <br>
                        ...
                        <c:when test="${list.size() != 0}">
                            <c:forEach var="sk" items="${list}">
                                <tr>
                                    ...
                                    <td>${sk.title}</td>
                                    <td>
                                        <button class="btn btn-info" onclick="window.location.href = '/admin/teacher/edit/${sk.teacherId}'">编辑</button>
                                        <button class="btn btn-danger" onclick="delete_confirm(${sk.teacherId})">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:when>
...
<script type="text/javascript">
    ...
    function search()
    {
        ...
        window.location.href = "/admin/teacher/list/1?keyword=" + keyword;
    }
    ...
    function delete_confirm(teacherId){
        var page = ${page};
        var id = teacherId;
        var url = "/admin/teacher/delete";
                ...
                success:function(data){
                    if(data=="SUCCESS"){
                        if(${list.size()} == 1 && ${TotalPages} != 1) {
                            ...
                            window.location.href = "/admin/teacher/list/${page}?keyword=" + keyword;
                        }
                    }
                    else{
                        alert("删除失败");
