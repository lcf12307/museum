...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div>
                <a class="btn btn-primary" href="/admin/info/insertInfo" target="_self">添加通知</a>
                <a class="btn btn-primary " href = "/admin/info/download">下载报表</a>
                <td><a class="btn btn-primary" href = "/admin/info/upload">上传报表</a>
            </div>
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onclick="searchInfo()">查询</button>
                </span>
            </div>
            <div class="panel-body" >
                        ...
                        <c:when test="${list.size() != 0}">
                            <c:forEach items="${list}" var="info">
                                <tr>
                                    ...
                                    <td>${info.hasRead}</td>
                                    <td><a class="btn btn-info" href="/admin/info/edit/${info.id}" target="_self">编辑</a>
                                        <a class="btn btn-danger" onclick="delInfo(${info.id})" target="_blank">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:when>
                ...
                <div class="panel-button" align="right">
                    <a class="btn  btn-primary " href="/admin/info/list/1" target="_self">第一页</a>
...
<script type="text/javascript">
    function ahead(){
        ...
        if(${page} == 1 ) {
            ...
            window.location.href="/admin/info/list/${page-1}?searchKey="+searchKey;
        }
    }
    function behind(){
    ...
    function searchInfo() {
        ...
        window.location.href="/admin/info/list/1?searchKey="+searchKey;
    }
