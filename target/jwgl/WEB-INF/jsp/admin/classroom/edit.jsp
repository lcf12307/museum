            ...
            <div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="newRoomName" id="newRoomName"  type="text" value="${classroom.classroom}" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td><h5>容量(人)</h5></td>
                        <td>
                            <input name="peopleNum" id="peopleNum" type="text" placeholder="请输入1至999的某个数值" value="${classroom.peopleNum}" maxlength="3" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <button class="btn btn-primary" href="#" onclick="editClassroom();">确认编辑</button>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    function editClassroom(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data=="SUCCESS"){
                    alert("编辑成功");
                    window.location.href = "/admin/classroom/list";
                }
                else if(data=="NUM_FAIL"){
                    alert("输入的容量不合法，应为1至999的某个数值");
                }
                else{
                    alert("该教室已存在");
                }
