...
<div class="wrapper">
    ...
    <form action="/admin/${sessionScope.get("userid")}/searchresult" method="get">
       <br> <strong>请输入课程id号</strong>:<input name="courseId" type="text"><input type="submit"><br/></br>
    </form>
        ...
        <div class="panel-body">
            <div align="center">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <c:forEach items="${requestScope.coursesearch}" var="search">
                        <tr>
                            <td>${search.courseName}</td>
                            <td>${search.peopleNum}</td>
                            <td>${search.leftNum}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
