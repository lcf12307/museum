        ...
        <section class="content">
            <div id = "add-div">
                <table>
                    <tr>
                        <td><h5>开设id：</h5></td>
                        <td><h5>${result.courseId}</h5></td>
                    </tr>
                    <tr>
                        <td><h5>课程名称：</h5></td>
                        <td><h5>${result.courseName}</h5></td>
                    </tr>
                    <tr>
                        <td>
                            <h5>教师信息</h5>
                    ...
                    <tr>
                        <td><button class="btn btn-primary add-btn">添加</button></td>
                    </tr>
                </table>
                <br/>
            </div>
            ...
            <table class="table table-hove">
                ...
                <c:forEach items="${curarrangement}" var="curritem">
                    <tr>
                        <td>${curritem.id}</td>
            ...
            <div id="clash-schedule">
                <div class="callout callout-danger lead">
                    <h4>冲突安排!</h4>
                </div>
                <div id="clash-table-div"></div>
            </div>
        </section>
        <!-- /.content -->
    </div>
...
<script>
        ...
        $('.add-btn').on('click', function () {
            ...
            var url = "http://localhost:8080/admin/addschedule";
            $.ajax({
                type: 'POST',
                url: url,
                ...
                success: function (jsonResult) {
                    ...
                    if (resType === "SUCCESS") {
                        ...
                        $('.clash-edit-btn').on('click', function () {
                            ...
                            var url = "http://localhost:8080/admin/"+adminId+"/schedule/"+arrId+"/edit";
                            window.location.href = url;
                        });

                        $('.clash-delete-btn').on('click', function () {
                            var arrId = $(this).parent().parent().find("td:nth-child(1)").text();
                            var url = "http://localhost:8080/admin/deleteschedule";
