            ...
            <div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input id="id" name="id" class="form-control" type="text" maxlength="10" placeholder="请输入十位数字" onkeyup="checkId()" />
                        </td>
                        <td>
                            <div id="check"></div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <button class="btn btn-primary" href="#" onclick="insert();">添加新管理员</button>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function checkId() {
        ...
        $.ajax({
            ...
            success:function(data){
                document.getElementById("check").innerHTML = "<font color='red'>ID已存在</font>";
                flag = 1;
            },
            error:function(){
    ...
    function insert(){
        var id = $('#id').val();
        switch (true) {
            case id.length != 10 || isNaN(id) : alert("ID请输入10位数字!");break;
            case id > 2017000000 : alert("非法输入！前四位请输入小于等于当前年份的数字");break;
            case flag == 1: alert("ID已存在!");break;
            case id == "": alert("输入数据不能为空!");break;
            default : $.ajax({
                type: 'POST',
                ...
                success:function(data){
                    if(data=="SUCCESS"){
                        alert("添加成功");
                        window.location.href = "/admin/admin/list/1";
                    }
