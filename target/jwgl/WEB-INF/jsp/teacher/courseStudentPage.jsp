...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div align="center">
                <script>
                    tmp = "${requestScope.courseStudentList}";
                </script>
                <c:forEach var="entry" items="${requestScope.courseStudentList}">
                    <div>
                        <div class="panel-heading text-center">
                            <h3 align="center">${entry.value[0].courseName}</h3>
                        </div>
                        <button type="button" class="btn btn-default download-btn">下载名单</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach var="val" items="${entry.value}">
                                <tr>
                                    ...
                                    <td>${val.studentClassName}</td>
                                    <td>${val.studentMajor}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
