...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div>
                <h2 align="center">上传文档</h2>
            </div>
            <div id="selectDiv">
                <form action="/teacher/${teacherId}/grade/${openId}/uploadCheck" method="post" enctype="multipart/form-data" onsubmit="return check();">
                    <input id="file" type="file" name="file" size="80" accept="*/*" />
            ...
            <c:if test="${success!=null}">
                <script type="text/javascript">
                    alert("提交成功！");
                    window.location.href="/teacher/"+ ${teacherId}+ "/grade/"+ ${openId} +"/insert";
                </script>
            </c:if>
            <c:if test="${error!=null}">
                <div>
                    <h3>插入错误</h3>
                    <h3>可能出现了下面的错误，请检查你的文件</h3>
