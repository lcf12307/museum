    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <ul style="font-size:18px;line-height:2">
                <li>课题号：${checkSubjectDocu.subjectId}</li>
                <li>课题名称：${checkSubjectDocu.subjectName}</li>
                <li>指导教师：${checkSubjectDocu.teacherName}</li>
                <li>课题要求：</li>
            </ul>
            <pre style="font-size:18px;line-height:2">
                ${checkSubjectDocu.requirement}
            </pre>
            文档：${checkSubjectDocu.document}
            <form action="../upload.do" method="post" enctype="multipart/form-data">
                <input class="btn btn-info" type="file" name="myfiles"/>
