...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <%if ((Integer)session.getAttribute("subjectStatus") == 2 ){%>
            文档：${checkSubjectInfo.document}<br>
            <form action="../upload.do" method="post" enctype="multipart/form-data">
                文件1: <input type="file" name="myfiles"/><br/>
                <input type="submit" value="上传">
            </form>
            <%--文档： <button type="button" onclick="">上传 </button><br>--%>
            <%}%>
            <%if ((Integer)session.getAttribute("subjectStatus") == 3 ){%>
            <div align="center">
                <button class="btn btn-success" type="button" onclick="javascript:window.location.href='../insertSelectSubject/${checkSubjectInfo.subjectId}';">申请 </button><br>
            </div>
            <%}%>
        </section>
        <!-- /.content -->
