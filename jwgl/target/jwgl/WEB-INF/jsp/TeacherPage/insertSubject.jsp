...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="./addSubject" role = "form" name="subjectForm" method="post" style="font-size:18px;line-height:2">
                ...
                <div class="form-group" style="width: 50%">
                    ...
                    <textarea class="form-control" rows="8" id="subjectRequirement" name="subjectRequirement"></textarea>
                </div>
                <div align="left">
