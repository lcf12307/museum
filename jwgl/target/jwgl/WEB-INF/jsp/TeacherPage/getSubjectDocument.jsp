    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <ul style="font-size:18px;line-height:2">
                <li>课题号：${getSubjectDocument.subjectId}</li>
                <li>课题名称：${getSubjectDocument.subjectName}</li>
                <li>学号：${getSubjectDocument.studentId}<br></li>
                <li>学生姓名：${getSubjectDocument.studentName}<br></li>
                <li>课题要求：</li>
                <pre style="font-size: 18px;line-height: 2">
                    ${getSubjectDocument.requirement}
                </pre>
                <li> 文档：${getSubjectDocument.document}</li>
                <c:if test="${getSubjectDocument.document != null}">
                    <a class="btn btn-success btn-sm" href="../download.do?fileName=${getSubjectDocument.document}">下载</a><br>
                </c:if>
                <c:if test="${getSubjectDocument.document == null}">
                    该学生未上传文档！<br>
                </c:if>
