...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="../update/${getSubjectInfo.subjectId}" role = "form" name="subjectForm" method="post" style="font-size:18px;line-height:2">
                <label>课题号:</label>
                ${getSubjectInfo.subjectId}<br>
                <div class="form-group" style="width: 50%">
                    <label for="subjectName">课题名称</label>
                    <input name = "subjectName" id="subjectName" type="text" value="${getSubjectInfo.subjectName}" class="form-control">
                    <label for="subjectRequirement">课题要求</label>
                    <textarea name="subjectRequirement" id="subjectRequirement" rows="8" class="form-control">${getSubjectInfo.subjectRequirement}</textarea>
                </div>
