...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div>
                <form class="sign-up" action="/admin/${sessionScope.get("userid")}/detailinfo" method="get">
                    <h5>学期选择</h5>
                    <select class="year-input" name="year">
                    <c:forEach items="${requestScope.termyear}" var="termyear">
                        <option value="${termyear.schoolYear}">${termyear.schoolYear}学年</option>
                    </c:forEach>
                    </select>
                    <select class="term-input" name="term">
                        <c:forEach items="${requestScope.termyear}" var="termyear">
                            <option value="${termyear.term}">第${termyear.term}学期</option>
                        </c:forEach>
                    </select>
