    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <c:forEach items="${requestScope.statisticres}" var="statistic">
                    <tr>
                        <td>${statistic.courseId}</td>
                        <td>${statistic.courseName}</td>
                        <td>${statistic.peopleNum}</td>
                        <td>${statistic.leftNum}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
