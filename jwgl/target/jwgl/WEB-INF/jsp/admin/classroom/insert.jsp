            ...
            <h2>添加新教室</h2>
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="classroom" id="classroom"  type="text" value="" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="peopleNum" id="peopleNum" type="text" placeholder="请输入1至999的某个数值" value="" maxlength="3" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <button class="btn btn-primary" href="#" onclick="insertClassroom();">添加新教室</button>
                        </td>
                    </tr>
                </table>
            </div>
