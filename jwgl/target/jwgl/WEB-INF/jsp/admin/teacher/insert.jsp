        ...
        <section class="content">
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <button class="btn btn-primary" href="#" onclick="insert();">添加新教师</button>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function checkId() {
        ...
        $.ajax({
            ...
            success:function(data){
                document.getElementById("check").innerHTML = "<font color='red'>工号已存在</font>";
                flag = 1;
            },
            error:function(){
    ...
    function insert(){
        ...
        var title = $('#title').val();
        switch (true) {
            case id.length != 10 || isNaN(id) : alert("工号请输入10位数字!");break;
            case id > 2017000000 : alert("非法输入！前四位请输入小于等于当前年份的数字");break;
            case flag == 1: alert("工号已存在!");break;
            case id == "" || name == "" || title == "" : alert("输入数据不能为空!");break;
            default : $.ajax({
                type: 'POST',
