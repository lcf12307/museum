            ...
            <div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input id="title" name="title" class="form-control" type="text" value="${info.title}" />
                        </td>
                    </tr>
                    <tr>
                        <td><h4>发布者</h4></td>
                        <td>
                            <input id="sender" name="sender" type="text" class="form-control" value="${info.sender}" >
                        </td>
                    <tr>
                        <td><h4>接收者id</h4></td>
                        <td>
                            <input id="student_id" name="student_id" type="text" maxlength="10" class="form-control" value="${info.studentId}" >
                        </td>
                    </tr>
                    <tr>
                        <td><h4>正文</h4></td>
                        <td>
                            <textarea id="context" name="context" type="" class="form-control" >${info.context}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<script type="text/javascript">
    ...
    function updateInformation(){
        ...
        switch (true) {
            case student_id.length != 10 || isNaN(student_id) : alert("ID请输入10位数字!");break;
            case student_id > 2017000000 : alert("非法输入！前四位请输入小于等于当前年份的数字");break;
            case student_id == "": alert("输入数据不能为空!");break;
            default :
                $.ajax({
                type: 'POST',
                url: '/admin/info/updateInfo' ,
                dataType: 'json',
                ...
                success:function(data){
                    alert("修改成功");
                    window.location.href = "/admin/info/list/1";
                },
                error:function(){
                    alert("修改数据失败！");
                }
