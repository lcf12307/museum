            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td><h5>接收者ID</h5></td>
                        <td>
                            <input id="student_id" name="student_id" type="text" maxlength="10" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td><h5>正文</h5></td>
                        <td>
                            <textarea id="context" name="context" type="" class="form-control"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <button class="btn btn-primary" href="#" onclick="insert();">添加通知</button>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function insert(){
        ...
        if(title == "" || sender == "" ||student_id == "" ||context== ""){
            alert("输入数据不能为空");
        } else if(student_id.length != 10 || isNaN(student_id)){
            alert("发送者ID请输入十位数字");
        } else {
            $.ajax({
                type: 'POST',
