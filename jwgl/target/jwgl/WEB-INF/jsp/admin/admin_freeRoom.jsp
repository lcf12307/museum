            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td><button class="btn btn-primary query-btn">查询</button></td>
                    </tr>
                </table>
            </div>
            <div id="content-div">
...
<script>
        ...
        $('.query-btn').on('click', function () {
            ...
            var url = "http://localhost:8080/admin/freerooms";
            $.ajax({
                type: 'POST',
                url: url,
                ...
                success: function (jsonResult) {
                    ...
                    $('#content-div').empty();
                    $('#content-div').append(
                        '<table class="table table-hover res-table"><thead><tr><th>教室</th><th>教室大小</th></tr></thead></table>'
                    );
                    for (var index in jsonResult["result"]) {
                        $('.res-table').append(
                            '<tr><td>'+jsonResult["result"][index]["classroom"]+'</td><td>'+jsonResult["result"][index]["peopleNum"]+'</td></tr>'
                        );
                    }
                },
                error: function (e) {
